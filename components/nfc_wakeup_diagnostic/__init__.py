...
wakeup_ns = cg.esphome_ns.namespace("nfc_wakeup_diagnostic")
NfcWakeupDiagnostic = wakeup_ns.class_("NfcWakeupDiagnostic", cg.Component, i2c.I2CDevice)

CONFIG_SCHEMA = cv.Schema(
    {
        cv.GenerateID(): cv.declare_id(NfcWakeupDiagnostic),
